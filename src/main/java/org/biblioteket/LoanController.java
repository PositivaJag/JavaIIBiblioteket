...
public class LoanController extends Controllers{
    ...
    public void initialize() {
        ...
        //Gets and sets relevant info about activeUser's loans. 
        setUserData();
        printUserData();
    ...
    /**
     * Sends a request to add the Loans to the DB. If ok, asks if user want to
     * print a reciept.
     * @param event
     */
    @FXML
    ...
    /**
     * Get låntagarkategori for activeUser to get max number of loans. Get
     * number of existing loans. Set values to activeUser.
     */
    ...
    /**
     * Print the information that was gathered in setUserData. - Max number of
     * loans - Number of existing loans - How many new loans that can be made.
     */
